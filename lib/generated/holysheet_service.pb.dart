...
class StoreCodeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StoreCodeRequest', package: const $pb.PackageName('com.uddernetworks.grpc'), createEmptyInstance: create)
    ..aOS(1, 'code')
    ..hasRequiredFields = false
  ;

  StoreCodeRequest._() : super();
  factory StoreCodeRequest() => create();
  factory StoreCodeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StoreCodeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  StoreCodeRequest clone() => StoreCodeRequest()..mergeFromMessage(this);
  StoreCodeRequest copyWith(void Function(StoreCodeRequest) updates) => super.copyWith((message) => updates(message as StoreCodeRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StoreCodeRequest create() => StoreCodeRequest._();
  StoreCodeRequest createEmptyInstance() => create();
  static $pb.PbList<StoreCodeRequest> createRepeated() => $pb.PbList<StoreCodeRequest>();
  @$core.pragma('dart2js:noInline')
  static StoreCodeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StoreCodeRequest>(create);
  static StoreCodeRequest _defaultInstance;
...
class StoreCodeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StoreCodeResponse', package: const $pb.PackageName('com.uddernetworks.grpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  StoreCodeResponse._() : super();
  factory StoreCodeResponse() => create();
  factory StoreCodeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StoreCodeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  StoreCodeResponse clone() => StoreCodeResponse()..mergeFromMessage(this);
  StoreCodeResponse copyWith(void Function(StoreCodeResponse) updates) => super.copyWith((message) => updates(message as StoreCodeResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StoreCodeResponse create() => StoreCodeResponse._();
  StoreCodeResponse createEmptyInstance() => create();
  static $pb.PbList<StoreCodeResponse> createRepeated() => $pb.PbList<StoreCodeResponse>();
  @$core.pragma('dart2js:noInline')
  static StoreCodeResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StoreCodeResponse>(create);
